...
], [cutscene_change_room, 228], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 1407, 415], [cutscene_wait, 20], [function()
    {
...
], [cutscene_wait, 50], [cutscene_change_room, 214], [cutscene_set_player_visible, 0], [cutscene_set_player_pos, 190, 600], [cutscene_soundeffect, 27], [cutscene_camera_shake, 5, (3 / room_speed)], [cutscene_wait, 50], [function()
    {
        with (obj_freezerblock)
            instance_destroy()
        cutscene_end_action()

function state_player_normal()
{
    ...
    {
        case "P":
            if (key_attack && state != (42 << 0) && (!(place_meeting((x + xscale), y, obj_solid))) && ((!(place_meeting(x, (y + 1), obj_iceblockslope))) or (!(place_meeting((x + (xscale * 5)), y, obj_solid)))) && (!global.kungfu))
            {

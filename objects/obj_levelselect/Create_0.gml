...
level_array[5][0] = ["TOP", top_1, "top"]
level_array[5][1] = ["DRAGON LAIR", dragonlair_1, "dragonlair"]
level_array[5][2] = ["OREGANO DESERT", desert_1, "desert"]
level_array[5][3] = ["PINBALL", pinball_1, "pinball"]
level_array[5][4] = ["PINEAPPLE BEACH", beach_1, "beach"]
level_array[5][5] = ["CITY", city_1, "city"]

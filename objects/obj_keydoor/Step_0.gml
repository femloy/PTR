if ((!global.horse) && (!instance_exists(obj_jumpscare)) && (obj_player1.state == (0 << 0) or obj_player1.state == (103 << 0) or obj_player1.state == (58 << 0) or obj_player1.state == (104 << 0) or obj_player1.state == (121 << 0) or obj_player1.state == (99 << 0)) && sprite_index == spr_doorkey && obj_player1.key_up && obj_player1.grounded && global.key_inv == 1 && place_meeting(x, y, obj_player1))
{

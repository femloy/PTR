...
if instance_exists(baddieID)
{
	...
	if place_meeting(x, y, obj_player) && baddieID.state != states.grabbed && !baddieID.invincible && baddieID.state != states.ghostpossess
	{
		with obj_player
		{
			var _playerindex = object_index == obj_player1 ? 1 : 2;
			if !place_meeting(x, y, other) or cutscene
				exit;
